---
summary: "Run Moltbot with Azure AI Foundry (Azure OpenAI and other Azure-hosted models)"
read_when:
  - You want to run Moltbot with Azure AI Foundry
  - You need Azure OpenAI or Azure-hosted model setup guidance
  - You want to use custom Azure model deployments
---
# Azure AI Foundry

Azure AI Foundry is Microsoft's unified AI platform that provides access to OpenAI models (GPT-4, GPT-4.1, etc.) and other models through Azure. Moltbot integrates with Azure AI Foundry using the OpenAI-compatible API.
